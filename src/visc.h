...
#define SYSCON_START 0x80000001
#define UART_START 0x80000002
#define STORAGE_START 0x80000003

#define DEFAULT_STACK_START 0x00000100
#define DEFAULT_STACK_END 0x00000FFF
